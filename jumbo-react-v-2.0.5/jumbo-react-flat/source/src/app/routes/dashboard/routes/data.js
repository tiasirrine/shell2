...
export const countryList1 = [
    {name: 'India', flagCode: 'in', badge: '27', badgeColor: 'primary'},
...
export const weatherList = [
    {img: '501', date: 'Thursday, 4 Nov', temp: '27'},
    {img: '500', date: 'Wednesday, 3 Nov', temp: '32'},
    {img: '500', date: 'Tuesday, 2 Nov', temp: '25'},
    {img: '500', date: 'Monday, 1 Nov', temp: '29'},
];
...
export const todoData = [
    {
        'id': 1,
        'title': 'Mouldifi',
        'notes': 'Design wireframes for the latest pages added in the SRS doc.',
        'selected': false,
    },
    {
        'id': 2,
        'title': 'Jumbo React',
        'notes': 'Add a new mailbox app under app modules section',
        'selected': true,
    },
    {
        'id': 3,
        'title': 'Chatbull iOS App',
        'notes': 'Integrate push notifications with the latest APIs',
        'selected': false,
    },
