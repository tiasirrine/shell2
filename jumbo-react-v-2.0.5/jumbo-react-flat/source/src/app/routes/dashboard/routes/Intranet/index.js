    ...
    render() {
        ...
        return (
            <div className="dashboard animated slideInUpTiny animation-duration-3">
                ...
                <div className="row">
                    <div className="col-lg-3 col-sm-6 col-12">
                        <UserProfileCard headerStyle="bg-grey lighten-4"/>
                    </div>
                        ...
                        <div className="jr-card">
                            <div className="jr-card-header d-flex">
                                ...
                                <Dropdown isOpen={menuState}
                                    ...
                                    <CardMenu menuState={menuState}
                                              onOptionMenuToggle={this.onOptionMenuToggle.bind(this)}
